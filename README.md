...
Built and deployed a custom model on Amazon SageMaker, containerizing code via Docker, training on sample datasets, deploying to an SageMaker inference endpoint, and validated results for accuracy

![Infrastructure](https://github.com/marlhex/AmazonSageMaker_ContainerizedCode_Docker_CustomModel/assets/4165637/f7410704-7a39-4cc0-94b6-335b06e1975a)


![stack](https://github.com/marlhex/AmazonSageMaker_ContainerizedCode_Docker_CustomModel/assets/4165637/a963b43a-197c-4643-ade3-c00dde93ec22)


# Bring-your-own Algorithm Sample

This example shows how to package an algorithm for use with SageMaker. We have chosen a simple [scikit-learn][skl] implementation of linear regression to illustrate the procedure.
...
* __linear-regression__: The directory that contains the application to run in the container. See the next session for details about each of the files.
